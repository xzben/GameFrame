...
local ScrollMap = class("ScrollMap", core.EventDispatcher)


local ScrollMapEvent = {
	EVT_SCROLL_DONE = 1,		--已经滚动到最后一个页面了
	EVT_CHANGE_MAIN_LAYER = 2, 	--切换主显示页面
}

--底图滚动方向
local ScrollMapMoveDir = {
	LEFT 	= 1,
	RIGHT 	= 2,
	TOP 	= 3,
	BOTTOM 	= 4,
...
ScrollMap.ScrollMapEvent = ScrollMapEvent
ScrollMap.ScrollMapMoveDir = ScrollMapMoveDir
